---
name: sync-skills
description: Gebruik dit wanneer core.md-bestanden in deze repo (claude-plugins-zwijsen) zijn aangepast of een nieuwe skill is toegevoegd onder core/, en de gegenereerde output in claude-code/, copilot/ en chatgpt/ opnieuw gesynct moet worden.
---
